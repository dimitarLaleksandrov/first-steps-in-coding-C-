...
namespace BookingApp.Models.Hotels
{
    public class Hotel : IHotel
    {
        ...
        public double Turnover
        {
            get
            {
                return this.Bookings.All().Sum(x => Math.Round(x.ResidenceDuration * x.Room.PricePerNight, 2));
            }
        }
        ...
        public IRepository<IBooking> Bookings { get => bookings;  set => bookings = value; }
    }
}
